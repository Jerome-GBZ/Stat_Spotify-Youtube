...
En conclusion, notre projet visait à explorer la possibilité d'identifier des caractéristiques musicales communes parmi les titres les plus appréciés par les utilisateurs.
Après avoir analysé les données, nos résultats indiquent qu'il n'y a pas de différence significative dans la danseabilité des morceaux de musique en fonction de la fréquence d'écoute.
Cela suggère que la danseabilité ne semble pas être un critère déterminant dans la popularité des titres.

Par ailleurs, nos résultats mettent en évidence une relation significative entre la fréquence d'écoute des morceaux de musique et le type d'album (album ou single).
Cette observation suggère que les utilisateurs ont tendance à écouter plus fréquemment des singles plutôt que des musiques qui sont dans un album.
