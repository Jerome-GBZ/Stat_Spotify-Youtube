...
D'après le diagramme boîte à moustaches, on constate que la majorité des musiques, soit environ 58 %, ont pour effet de faire danser les personnes qui les écoutent. Par ailleurs, il est intéressant de noter que seulement 25 % des musiques ont un effet dansant sur 70 % de la population. Enfin, on peut également observer que 50 % des musiques ont un effet dansant sur une personne sur deux. En d'autres termes, on peut dire que la musique a un effet dansant variable en fonction des individus, mais que la majorité des musiques ont un effet dansant sur une grande partie de la population.
