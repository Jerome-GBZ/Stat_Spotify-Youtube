...
• Calculer le rapport de corrélations. Commenter.
```{r}
cor.test(data$Danceability, data$Freq_listen)
#Error in cor.test.default(data$Danceability, data$Freq_listen) : 'y' must be a numeric vector
