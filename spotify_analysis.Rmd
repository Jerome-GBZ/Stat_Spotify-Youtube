...
```{r}
boxplot(data$Danceability ~ data$Freq_list, main="Danceability en fonction de la fréquence d'écoute", xlab="Fréquence d'écoute", ylab="Danceability")
```

```{r}
summary(data$Danceability[data$Freq_list == "peu écouté"])
summary(data$Danceability[data$Freq_list == "moyen écouté"])
summary(data$Danceability[data$Freq_list == "très écouté"])
```
